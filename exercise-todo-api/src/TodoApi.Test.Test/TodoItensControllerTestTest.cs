...
{
    [Trait("Category", "2 - Corrigir a rota de deletar tarefa.")]
...
{
    [Trait("Category", "3 - Corrigir a rota de adicionar tarefas.")]
...
{
    [Trait("Category", "4 - Corrigir a rota de atualizar tarefas.")]
