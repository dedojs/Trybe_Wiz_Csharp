...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/acc-csharp-0x-exercises-magazine-control.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd acc-csharp-0x-exercises-magazine-control`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/acc-csharp-0x-exercises-magazine-control/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/acc-csharp-0x-exercises-magazine-control/pulls) e confira que o seu _Pull Request_ está criado
