...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/acc-csharp-0x-exercises-eshop.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd acc-csharp-0x-exercises-eshop`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/acc-csharp-0x-exercises-eshop/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/acc-csharp-0x-exercises-eshop/pulls) e confira que o seu _Pull Request_ está criado
